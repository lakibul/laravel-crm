    ...
    <div class="d-flex flex-stack flex-grow-1">
        <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
            ...
            <a href="{{route('admin.home')}}" class="app-sidebar-logo">
                <img alt="Logo" src="{{ asset('/') }}assets/media/logos/crm-logo.png" class="h-100px theme-light-show" />
{{--                <img alt="Logo" src="assets/media/logos/demo39-dark.svg" class="h-25px theme-dark-show" />--}}
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
            ...
            <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                <!--begin::Menu wrapper-->
                <p><h4>{{ \Illuminate\Support\Facades\Auth::user()->name}}</h4></p>
                <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px ml-2" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                    @if(\Illuminate\Support\Facades\Auth::user()->fileManager)
                        <img src="{{ \Illuminate\Support\Facades\Auth::user()->fileManager->url}}" alt="image" style="background-position: center"/>
                    @else
                        <img src="{{ asset('/') }}assets/media/avatars/no_avatar.png" alt="image"/>
                    @endif
                </div>
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{\Illuminate\Support\Facades\Auth::user()->name}}</a>
                            </div>
                            <!--end::Username-->
                        </div>
                    </div>
