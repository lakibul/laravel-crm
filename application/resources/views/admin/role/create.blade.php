                        ...
                        <form action="{{route('admin.role.store')}}" name="role-management-form" class="form mb-15" method="POST" id="kt_contact_form">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input value="{{ old('name') }}" type="text" class="form-control form-control-solid" placeholder="Enter Name" name="name" autocomplete="off"/>
                                        @if($errors->has('name'))
								...
								<!-- <div class="d-flex flex-column mb-5 fv-row col-md-6">
		                            <label class="required fs-6 fw-bold mb-2">Role Type</label>
										<select id="role_type" class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Select a Role Type" name="role_type">
                                            ...
                                            <option value="1" @if (old('role_type') == 1) selected="selected" @endif>Admin</option>
                                            <option value="2" @if (old('role_type') == 2) selected="selected" @endif>institute</option>
                                            <option value="3" @if (old('role_type') == 3) selected="selected" @endif>Student</option>
										</select>
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <div class="row" style="margin-top: 10px;margin-bottom: 15px;">
                                            <div class="col-md-12 form-check form-check-custom form-check-solid me-10">
                                                ...
                                                <input id="selectAll" class="form-check-input h-20px w-20px permission" type="checkbox" name="checkAll" value="{{old('checkAll', 1)}}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10 d-flex">
                                                ...
                                                @foreach($permission['permissions'] as $key => $single_permission)
                                                    <span>
                                                        <label class="form-check form-check-custom form-check-solid me-10">
                                                            <input class="form-check-input h-20px w-20px permission" type="checkbox" name="permissions[]" value="{{$single_permission['id']}}" />
                            ...
                            <div class="d-flex mb-5 fv-row">
                                <label class="form-check form-switch form-check-custom form-check-solid">
                                    ...
                                    <input class="form-check-input radio-btn" name="status" type="checkbox" value="1" checked="checked" />
                                </label>
                                <!--end::Switch-->
                            </div>
                            <div class="d-flex">
